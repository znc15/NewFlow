...
如果你正在开发 NewFlow 本体，而不是使用发布版，再执行 `npm install && npm run build`。
...
1. `cd /your/project`
2. `curl -L https://github.com/znc15/NewFlow/releases/latest/download/flow.js -o flow.js`
3. `chmod +x flow.js && node flow.js init`
4. 启动客户端
5. 直接描述需求
